    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="text-center">
                <a class="btn btn-primary" href="detalle_paquetes.php?id=<?php echo $paquet["productos_id"];?>&token=<?php
    ...
    <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="text-center">
            ...
            <a class="btn btn-primary" href="detalle_hoteles.php?id=<?php echo $hotell["productos_id"];?>&token=<?php
            echo hash_hmac("sha1",$hotell["productos_id"],KEY_TOKEN);?>">Ver detalles</a>
