...
<form method="post" action="">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input id="nombre" name="nombre" type="text" class="form-control" id="inputEmail3" placeholder="Ingrese su nombre">
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input id="apellido" name="apellido" type="text" class="form-control" placeholder="Ingrese su apellido">
        </div>
